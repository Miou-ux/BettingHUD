...
- pas de **rang/points** fiables sur les deux joueurs (`match_has_rank_points_source` dans `scripts/match_rank_quality.py`) — **depuis 23/07/2026** : exclusion si **un seul** joueur en stats modèle par défaut (100/1000) ;
